...
use BlackCat\Database\Packages\TenantDomains\Repository\TenantDomainRepository;
...
{
    private TenantDomainRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new TenantDomainRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\TenantDomains\Dto\TenantDomainDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\TenantDomains\Dto\TenantDomainDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\TenantDomains\Dto\TenantDomainDto|null
    {
