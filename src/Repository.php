...
use BlackCat\Database\Packages\TenantDomains\Repository\TenantDomainRepository as GeneratedRepository;
...
{
  private TenantDomainRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof TenantDomainRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected TenantDomainRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\TenantDomains\Dto\TenantDomainDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\TenantDomains\Dto\TenantDomainDto|null { return $this->repo->getById($id, $asDto); }
