...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'tenant_domains'; }
    public static function contractView(): string { return 'vw_tenant_domains'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'domain', 'domain_ci', 'is_primary', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'domain_ci' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id' ]; }
    ...
    public static function generatedColumns(): array { return [ 'domain_ci' ]; }
