...
final class TenantDomainsModule implements ModuleInterface
{
    public function name(): string { return 'table-tenant_domains'; }
    public function table(): string { return 'tenant_domains'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-tenants' ]; }

    public static function contractView(): string { return 'vw_tenant_domains'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_tenant_domains_tenant' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_tenant_domains_tenant' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_tenant_domains_tenant' ],
            'foreignKeys' => [ 'fk_tenant_domains_tenant' ],
        ];
    }
}
