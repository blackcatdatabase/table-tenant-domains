...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\tenant-domains](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\tenant-domains) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package tenant-domains -Apply
